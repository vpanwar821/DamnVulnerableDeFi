...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        this.rewarderAttacker = await RewarderAttackerFactory.deploy(this.rewarderPool.address, this.liquidityToken.address, this.flashLoanPool.address, this.rewardToken.address);
        this.rewarderAttacker.attack();
    });
